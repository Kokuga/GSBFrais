  ...
  <div class="container">
    <div class="jumbotron">
      ...
      ?>
        ...
        <div class='d-flex justify-content-end'><a href="index.php?uc=modePaiement&action=supprimerModePaiement&idPaiement=<?php echo $idPaiement ?>" onclick="return confirm('Voulez-vous vraiment supprimer ce mode de paiement? ');">Supprimer ce mode de paiement</a></td>
        </div>
      <?php } ?>
    ...
    <div class="jumbotron">
      <div class="container">
        <div style="text-align: center; padding-bottom: 1rem;">
          <h2 class="titre2">Ajouter un nouveau </h2>
          <h2 class="titre2">mode de paiement</h2>
        </div>
        <form action="index.php?uc=modePaiement&action=ajouterModePaiement" method="post">
          <div class="form-group">
            <div class='d-flex justify-content-center'>
              <label for="txtPaiementHF">
                <h6>Nom du mode de paiement :</h5>
              </label>
            </div>
            <div class='d-flex justify-content-center'>
